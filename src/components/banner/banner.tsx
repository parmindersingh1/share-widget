...
const Banner: FunctionalComponent<Props> = ({ config,toggled,handleClick }) => {

    return (        
            <div className="banner">
                <div class="relative overflow-hidden px-8 pt-8">
                    <div width="80" height="77" class="absolute -top-0 right-0">
                    ...
                    <div class="text-2xl flex flex-col pb-4">
                        ...
                        <span class="text-3xl font-bold">We are the Azapier !</span>
                    </div>
                    <div class="pb-4">
